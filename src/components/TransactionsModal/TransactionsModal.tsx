...
const TransactionsModal: React.FC<TransactionsModalProps> = ({
  ...
  const mappedRecentTransactions = fakeRecentTxs.map((item, index) => (
    <Box display="flex" key={`${index}${item.hash}`} justifyContent="space-between" alignItems="center" margin={moreThanFiveTXs ? "10px 4px 10px 0" : "10px 0px"}>
      <a
        ...
        <Box className={!mobile ? classes.wrapper : classes.wrapperMobile}>
          <Box className={! mobile ? classes.mainCard : classes.mainCardMobile}>
              ...
              <Box width="100%" marginTop="24px" display="flex" justifyContent="space-between" alignItems="center">
                ...
                <Box display="flex" justifyContent="space-between" alignItems="center" width="174px">
                  ...
                  <Button
                    ...
                    endIcon={(
                    <Box display="flex" alignItems="center" justifyContent="center" marginTop="2px">
            ...
            <Box className={!mobile ? classes.botSection : classes.botSectionMobile}>
              <Box display="flex" justifyContent="space-between" alignItems="center" marginRight="8px">
              ...
              <Box className={classes.transactionListContainer} style={!moreThanFiveTXs ? { marginRight: '14px' } : {}}>
