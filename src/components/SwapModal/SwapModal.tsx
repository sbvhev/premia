...
import { Typography, Modal, Box, Button, Input, Menu, MenuItem, Tooltip} from '@material-ui/core';
...
const SwapModal: React.FC<SwapModalProps> = ({
  ...
  const handleChangeFromAsset = (event: React.MouseEvent<HTMLButtonElement>) => {
        ...
        <Box className={!mobile ? classes.wrapper : classes.wrapperMobile}>
          <Box width={1} className={! mobile ? classes.mainCard : classes.mainCardMobile}>
            ...
            <Box className={!mobile ?  classes.topSection : classes.topSectionMobile}>
              ...
              <Box style={{ boxSizing: 'border-box', width: "100%", height: "46px", display: "flex", margin: "7px 2px 2px"}} id="topTarget">
            ...
            >
              ...
              <Box style={{ boxSizing: 'border-box', width: "100%", height: "46px", display: "flex", margin: "7px 0px 18px", maxWidth: '390px' }}>
                <Box width="65%" height="46px" maxWidth="250px">
                  <input
                    value={botInputValue}
                        ...
                        endIcon={
                          (
                            <Tooltip
                              ...
                              title={`You must give Premia permission to use your ${fromToken ? fromToken.ticker : ''} You only have to do this once per token.`}
                            >
            ...
            {swapReady && (
              <Box className={!mobile ? classes.swapDetailsSection : classes.swapDetailsSectionMobile}>
                <Box display="flex" justifyContent="space-between" alignItems="center">
                  <Typography className={classes.swapDetailsText} color="textSecondary">
                    Minimum Receive
                  </Typography>
                  <Typography className={classes.swapDetailsText} color="textPrimary">
                    {4.474}
                  </Typography>
                </Box>
                <Box display="flex" justifyContent="space-between" alignItems="center">
