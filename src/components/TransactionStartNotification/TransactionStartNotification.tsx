...
export interface TransactionStartNotificationProps {
  open: boolean;
  onClose: () => void;
}

const TransactionStartNotification: React.FC<TransactionStartNotificationProps> =
  ({ open, onClose }) => {
...
export default TransactionStartNotification;
